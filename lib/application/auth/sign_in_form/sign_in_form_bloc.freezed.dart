...
class _$LoginWithEmailAndPasswordPressed
  ...
  @override
  String toString() {
    return 'SignInFormEvent.loginWithEmailAndPasswordPressed()';
  }
...
abstract class LoginWithEmailAndPasswordPressed implements SignInFormEvent {
  ...
  _SignInFormState call(
      ...
      @required
          Option<Either<AuthFailure, Unit>>
              authFailureSuccessOrFailureOption}) {
    return _SignInFormState(
      emailAddress: emailAddress,
      password: password,
      isSubmitting: isSubmitting,
      showErrorMessages: showErrorMessages,
      authFailureSuccessOrFailureOption: authFailureSuccessOrFailureOption,
    );
  }
}
...
mixin _$SignInFormState {
  ...
  Option<Either<AuthFailure, Unit>> get authFailureSuccessOrFailureOption;
...
abstract class $SignInFormStateCopyWith<$Res> {
  ...
  $Res call(
      ...
      bool isSubmitting,
      bool showErrorMessages,
      Option<Either<AuthFailure, Unit>> authFailureSuccessOrFailureOption});
}
...
class _$SignInFormStateCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    Object authFailureSuccessOrFailureOption = freezed,
  }) {
    return _then(_value.copyWith(
      ...
      authFailureSuccessOrFailureOption:
          authFailureSuccessOrFailureOption == freezed
              ? _value.authFailureSuccessOrFailureOption
              : authFailureSuccessOrFailureOption
...
class _$_SignInFormState implements _SignInFormState {
  const _$_SignInFormState(
      ...
      @required this.authFailureSuccessOrFailureOption})
      : assert(emailAddress != null),
        assert(password != null),
        assert(isSubmitting != null),
        assert(showErrorMessages != null),
        assert(authFailureSuccessOrFailureOption != null);
  ...
  @override
  final Option<Either<AuthFailure, Unit>> authFailureSuccessOrFailureOption;

  @override
  String toString() {
    return 'SignInFormState(emailAddress: $emailAddress, password: $password, isSubmitting: $isSubmitting, showErrorMessages: $showErrorMessages, authFailureSuccessOrFailureOption: $authFailureSuccessOrFailureOption)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is _SignInFormState &&
            ...
            (identical(other.authFailureSuccessOrFailureOption,
                    authFailureSuccessOrFailureOption) ||
                const DeepCollectionEquality().equals(
                    other.authFailureSuccessOrFailureOption,
                    authFailureSuccessOrFailureOption)));
  }
  ...
  int get hashCode =>
      ...
      const DeepCollectionEquality().hash(authFailureSuccessOrFailureOption);
...
abstract class _SignInFormState implements SignInFormState {
  const factory _SignInFormState(
      ...
      @required
          Option<Either<AuthFailure, Unit>>
              authFailureSuccessOrFailureOption}) = _$_SignInFormState;
